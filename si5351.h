...
#include "Arduino.h"
#include <i2c_t3.h> // used instead of Wire.h
#include <stdint.h>
...
#define SI5351_TIMEOUT	500000 // [us] default timeout applied to all function calls which do not explicitly set a timeout (0=inf)
